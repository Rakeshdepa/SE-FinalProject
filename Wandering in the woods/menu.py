    ...
    while True:
        ...
        if button_2.collidepoint((mx, my)):
            if click:
                print("Options Menu")
                options()
        pygame.draw.rect(screen, (128, 0, 255), button_1)
        draw_text('Start', font, (255, 255, 255), screen, 220, 210)
        pygame.draw.rect(screen, (128, 0, 255), button_2)
        draw_text('Set Volume', font, (255, 255, 255), screen, 200, 310)
        click = False
...
def game_Menu():
    ...
    while running:
        ...
        # draw button
        pygame.draw.rect(screen, (158, 0, 255), button_1)
        draw_text("Basic Map", font, (255, 255, 255), screen, 200, 110)
        pygame.draw.rect(screen, (158, 0, 255), button_2)
        draw_text('Build Your Map', font, (255, 255, 255), screen, 180, 210)
        pygame.draw.rect(screen, (158, 0, 255), button_3)
        draw_text('Multiple Player', font, (255, 255, 255), screen, 180, 310)
...
def k2_game():
    ...
    while running:
        ...
        # draw button
        pygame.draw.rect(screen, (158, 0, 255), button_1)
        draw_text('Easy', font, (255, 255, 255), screen, 220, 110)
        pygame.draw.rect(screen, (158, 0, 255), button_2)
        draw_text('Medium', font, (255, 255, 255), screen, 220, 210)
        pygame.draw.rect(screen, (158, 0, 255), button_3)
        draw_text('Hard', font, (255, 255, 255), screen, 220, 310)
...
def multiPlayerGameMenu():
    ...
    while running:
        ...
        # draw button
        pygame.draw.rect(screen, (158, 0, 255), button_1)
        draw_text('Dual Player', font, (255, 255, 255), screen, 200, 110)
        pygame.draw.rect(screen, (158, 0, 255), button_2)
        draw_text('Three Player', font, (255, 255, 255), screen, 200, 210)
        pygame.draw.rect(screen, (158, 0, 255), button_3)
        draw_text('Four Player', font, (255, 255, 255), screen, 200, 310)
...
def options():
    ...
    while running:
        ...
        button_3 = pygame.Rect(150, 250, 200, 50)
        ...
        pygame.draw.rect(screen, (158, 0, 255), button_1)
        draw_text('Volume Low', font, (255, 255, 255), screen, 180, 160)
        pygame.draw.rect(screen, (158, 0, 255), button_3)
        draw_text('Volume High', font, (255, 255, 255), screen, 180, 260)
        optionClick = False
